...
export class Migration1745493587730 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."roles_name_enum" AS ENUM('owner', 'admin', 'manager', 'user')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('owner', 'admin', 'manager', 'user')`);
        ...
        await queryRunner.query(`CREATE TYPE "owner"."admins_role_enum" AS ENUM('owner', 'admin', 'manager', 'user')`);
